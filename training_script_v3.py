# usage examples:
# Single GPU Training : CUDA_VISIBLE_DEVICES=0 python3 training_script_v3.py 
# Multi GPU Training : torchrun --nproc_per_node=2 --master_port=29500 training_script_v3.py
...
class TrainingConfig:
    def __init__(self):
        # Model configuration
        self.MODEL_NAME = "./llama-3-meerkat-8b-v1.0"
        ...
        self.LORA_TARGET_MODULES = ["q_proj", "v_proj"] # "q_proj", "k_proj", "v_proj", # All attention
                                                        # "o_proj",  "gate_proj", "up_proj", "down_proj"      # All MLP layers
        ...
        self.NUM_EPOCHS = 3
        self.BATCH_SIZE = 2 # change this to higher value
        ...
        self.DDP_FIND_UNUSED_PARAMETERS = False  # Distributed training
